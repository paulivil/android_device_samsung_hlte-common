...
BOARD_KERNEL_CMDLINE := console=null androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x3F  androidboot.bootdevice=msm_sdcc.1 audit=0 selinux=0 enforcing=0 androidboot.selinux=permissive
